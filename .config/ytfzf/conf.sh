...
YTFZF_EXTMENU=' rofi -dmenu -theme ytfzf-theme.rasi -fuzzy -width 1500'
...
#vlc also works
#(YTFZF_PLAYER)
video_player="devour mpv --script=$HOME/.config/mpv/mpris.so"
...
#(YTFZF_AUDIO_PLAYER)
audio_player="mpv --no-video --script=$HOME/.config/mpv/mpris.so"
