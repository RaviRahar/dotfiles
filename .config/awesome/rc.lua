...
--awful.key({}, "XF86AudioMute", function() os.execute("pactl set-sink-mute @DEFAULT_SINK@ toggle") end),
    ...
    awful.key({ modkey, }, "r",
        function() awful.spawn.with_shell("rofi -show combi -c $HOME/.config/rofi/config.rasi -theme launcher-theme.rasi"
                , awful.rules.rules)
        end,
        { description = "run prompt", group = "launcher" }),
    awful.key({ modkey, "Shift" }, "r",
        function() awful.spawn.with_shell("rofi -show combi -c $HOME/.config/rofi/config.rasi -theme dmenu-theme.rasi",
                awful.rules.rules)
        end,
    ...
    awful.key({ modkey, }, "c",
        function() awful.spawn(terminal .. " --class nmtui -e nmtui-connect", awful.rules.rules) end,
    ...
    awful.key({}, "XF86Launch1", function() awful.spawn.with_shell("maim -u -s -m 10 " ..
            "$HOME/Pictures/Screenshots/screenshot-$(date +%Y-%m-%d_%H-%M-%S).png")
    end,
