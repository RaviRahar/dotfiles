...
--vim.api.nvim_exec([[autocmd BufWritePre *go,*.py lua vim.lsp.buf.formatting_sync(nil, 100)]], false)
--vim.api.nvim_exec([[autocmd CursorHold * lua vim.diagnostic.open_float({ focusable = false })]], false)
