...
if theme == "gruvbox_dark" then
    -- Dark Theme
    mytagseparator =
        wibox.widget.textbox('<span font="notosans 16" foreground="#458588" background="#222222"></span>')
    mynetspeedseparator =
        wibox.widget.textbox('<span font="notosans 16" foreground="#b16286" background="#222222"></span>')
elseif theme == "gruvbox_light" then
    -- Light Theme
    mytagseparator =
        wibox.widget.textbox('<span font="notosans 16" foreground="#458588" background="#ebdbb2"></span>')
    mynetspeedseparator =
        wibox.widget.textbox('<span font="notosans 16" foreground="#b16286" background="#ebdbb2"></span>')
end

local mynetworkseparator =
    wibox.widget.textbox('<span font="notosans 16" foreground="#83a598" background="#b16286"></span>')
local mybrightnesseparator =
    wibox.widget.textbox('<span font="notosans 16" foreground="#d3869b" background="#83a598"></span>')
local mysoundseparator =
    wibox.widget.textbox('<span font="notosans 16" foreground="#83a598" background="#d3869b"></span>')
local mybatteryseparator =
    wibox.widget.textbox('<span font="notosans 16" foreground="#fabd2f" background="#83a598"></span>')
local mydateseparator =
    wibox.widget.textbox('<span font="notosans 16" foreground="#282828" background="#fabd2f"></span>')
local mytimeseparator =
    wibox.widget.textbox('<span font="notosans 16" foreground="#ebdbb2" background="#282828"></span>')
local mymenuseparator =
    wibox.widget.textbox('<span font="notosans 16" foreground="#689d6a" background="#ebdbb2"></span>')
...
if theme == "gruvbox_dark" then
    rofi_theme_launcher = "theme-launcher-gruvbox-dark"
    rofi_theme_dmenu = "theme-dmenu-gruvbox-dark"
elseif theme == "gruvbox_light" then
    rofi_theme_launcher = "theme-launcher-gruvbox-light"
...
--awful.key({}, "XF86AudioMute", function() os.execute("pactl set-sink-mute @DEFAULT_SINK@ toggle") end),
    ...
    awful.key({ modkey }, "e", function()
        awful.spawn("nemo", awful.rules.rules)
