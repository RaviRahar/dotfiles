...
if [ "$color_prompt" = yes ] && [ "$TERM" = "xterm-256color" ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;38;5;238;48;5;109m\] \w  \[\033[00;38;5;109m\]\[\033[00m\] '
##########################################################fg;######bg#######################fg###########reset##
elif [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;43;39m\] \w  \[\033[00;33m\]\[\033[00m\] '
else
